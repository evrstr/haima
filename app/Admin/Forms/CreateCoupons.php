...
class CreateCoupons extends Form
{
    ...
    public function form()
    {
        ...
        //$this->select('product_id', __('Belongs to the class'))->options(Classifys::all()->pluck('name'))->load('product_ids', 'commodity');
        ...
        $this->currency('discount', __('Discount'))->rules('required|numeric', ['required' => '优惠金额不能为空', 'numeric' => '请正确填写金额，整数或小数'])->default(0.99);
