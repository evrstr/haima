...
class PaysController extends AdminController
{
    ...
    protected function grid()
    {
        ...
        $states = [
            ...
            'off' => ['value' => 2, 'text' => '停用', 'color' => 'default'],
        ];
        $grid->column('pay_status', __('Pay status'))->switch($states);;
    ...
    protected function form()
    {
        ...
        $form->switch('pay_status', __('Pay status'))->rules('required', ['请选择状态'])->states($states);
