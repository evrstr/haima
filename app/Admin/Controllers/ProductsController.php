...
class ProductsController extends AdminController
{
    ...
    protected function grid()
    {
        ...
        $grid->column('pd_name', __('Pd name'));
        $grid->column('pd_picture', __('Pd picture'))->image();
        $grid->column('classify.name', __('Pd class'))->label('success');
        ...
        $grid->column('usage_days', __('usage_days'));
    ...
    protected function form()
    {
        ...
        $form->number('usage_days', __('usage_days'))->required()->default(1);
