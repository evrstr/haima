...
INSERT INTO `admin_menu` VALUES (13, 0, 17, '优惠管理', 'fa-heart', NULL, NULL, '2020-04-03 18:56:40', '2021-02-16 19:34:53');
INSERT INTO `admin_menu` VALUES (14, 13, 18, '优惠码列表', 'fa-barcode', '/coupons', NULL, '2020-04-03 18:57:51', '2021-02-16 19:34:53');
INSERT INTO `admin_menu` VALUES (15, 13, 19, '生成优惠码', 'fa-plus-square', '/createcoupons', NULL, '2020-04-03 19:12:41', '2021-02-16 19:34:53');
INSERT INTO `admin_menu` VALUES (16, 0, 20, '配置', 'fa-gears', NULL, NULL, '2020-04-03 21:32:33', '2021-02-16 19:34:53');
INSERT INTO `admin_menu` VALUES (17, 16, 23, '支付网关', 'fa-bars', '/pays', NULL, '2020-04-03 21:32:48', '2021-02-16 19:34:53');
INSERT INTO `admin_menu` VALUES (18, 16, 22, '邮件模板配置', 'fa-envelope', '/emailtpls', NULL, '2020-04-03 22:18:12', '2021-02-16 19:34:53');
INSERT INTO `admin_menu` VALUES (19, 16, 21, '系统配置', 'fa-gear', '/setting', NULL, '2020-04-03 22:48:30', '2021-02-16 19:34:53');
INSERT INTO `admin_menu` VALUES (20, 16, 24, '核心配置', 'fa-toggle-on', 'config', NULL, '2020-04-03 23:29:39', '2021-02-16 19:34:53');
INSERT INTO `admin_menu` VALUES (21, 0, 13, '卡密管理', 'fa-credit-card-alt', NULL, NULL, '2020-04-03 23:44:19', '2020-04-03 23:45:22');
INSERT INTO `admin_menu` VALUES (22, 21, 14, '卡密列表', 'fa-credit-card', '/cards', NULL, '2020-04-03 23:45:40', '2021-02-19 01:06:51');
INSERT INTO `admin_menu` VALUES (23, 21, 15, '导入卡密', 'fa-arrow-circle-right', '/importcards', NULL, '2020-04-03 23:59:18', '2021-02-19 01:06:51');
INSERT INTO `admin_menu` VALUES (24, 21, 16, '自动生成', 'fa-simplybuilt', '/autogeneration', NULL, '2021-02-16 19:33:57', '2021-02-19 01:06:51');
...
) ENGINE = InnoDB AUTO_INCREMENT = 1486 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `cards`  (
  ...
  `product_id` int(200) NOT NULL COMMENT '所属商品',
  `card_info` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '卡密',
  `card_status` int(1) NOT NULL DEFAULT 1 COMMENT '卡密状态1= 未出售，2=出售',
  `created_at` timestamp(0) NULL DEFAULT NULL COMMENT '创建时间',
  `updated_at` timestamp(0) NULL DEFAULT NULL COMMENT '更新时间',
  `check_status` int(1) NOT NULL DEFAULT 2 COMMENT '验证状态\r\n0=过期\r\n1=使用中\r\n2=未使用\r\n3=异常',
  `check_stime` int(11) NULL DEFAULT NULL COMMENT '第一次验证时间',
  `check_etime` int(11) NULL DEFAULT NULL COMMENT '验证结束时间',
  `machine_uuid` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '机器码',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `classifys`  (
  `id` int(200) NOT NULL AUTO_INCREMENT,
  `name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '商品名',
  `icon` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '图标',
  `ord` int(50) NOT NULL DEFAULT 1 COMMENT '排序',
  `c_status` int(1) NULL DEFAULT NULL COMMENT '是否启用',
  `created_at` timestamp(0) NULL DEFAULT NULL COMMENT '创建时间',
  `updated_at` timestamp(0) NULL DEFAULT NULL COMMENT '更新时间',
  `info` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '商品info',
  `appid` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'appid',
  `appsecret` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'appsecret',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of pays
-- ----------------------------
INSERT INTO `pays` VALUES (1, '支付宝当面付', 'zfbf2f', 'scan', '商户号', '', '密钥', '/pay/alipay', 2, '2019-03-11 05:04:52', '2021-02-19 01:29:40');
INSERT INTO `pays` VALUES (2, '支付宝pc', 'aliweb', 'dump', '商户号', '', '密钥', '/pay/alipay', 2, '2019-07-08 13:25:27', '2021-02-18 15:56:53');
INSERT INTO `pays` VALUES (3, '码支付QQ', 'mqq', 'dump', '商户号', NULL, '密钥', '/pay/mapay', 1, '2019-07-11 09:05:27', '2021-02-18 16:16:48');
INSERT INTO `pays` VALUES (4, '码支付支付宝', 'mzfb', 'dump', '商户号', NULL, '密钥', '/pay/mapay', 1, '2019-07-11 09:06:02', '2021-02-18 16:03:50');
INSERT INTO `pays` VALUES (5, '码支付微信', 'mwx', 'dump', '商户号', '', '密钥', '/pay/mapay', 2, '2019-07-11 09:06:23', '2021-02-18 16:15:34');
INSERT INTO `pays` VALUES (6, 'Paysapi支付宝', 'pszfb', 'dump', '商户号', '', '密钥', '/pay/paysapi', 2, '2019-07-11 09:31:12', '2021-02-18 16:03:54');
INSERT INTO `pays` VALUES (7, 'Paysapi微信', 'pswx', 'dump', '商户号', '', '密钥', '/pay/paysapi', 2, '2019-07-11 09:31:43', '2021-02-18 16:03:55');
INSERT INTO `pays` VALUES (8, '微信扫码', 'wescan', 'scan', '商户号', '', '密钥', '/pay/wepay', 2, '2019-07-12 07:50:20', '2021-02-18 16:03:55');
INSERT INTO `pays` VALUES (11, 'Payjs微信扫码', 'payjswescan', 'dump', '商户号', '', '密钥', '/pay/payjs', 2, '2019-07-25 07:28:42', '2021-02-18 16:03:55');
INSERT INTO `pays` VALUES (14, '易支付-支付宝', 'alipay', 'dump', '商户号', '', '密钥', '/pay/yipay', 2, '2020-01-10 15:22:56', '2020-01-11 06:33:07');
INSERT INTO `pays` VALUES (15, '易支付-微信', 'wxpay', 'dump', '商户号', NULL, '密钥', '/pay/yipay', 2, '2020-07-14 16:27:06', '2021-02-18 16:05:15');
INSERT INTO `pays` VALUES (16, '易支付-QQ钱包', 'qqpay', 'dump', '商户号', NULL, '密钥', '/pay/yipay', 2, '2020-07-14 16:27:03', '2021-02-18 16:05:16');
INSERT INTO `pays` VALUES (17, 'paypal', 'paypal', 'dump', '商户号', NULL, '密钥', '/pay/paypal', 2, '2020-07-14 16:25:20', '2021-02-18 16:05:17');
INSERT INTO `pays` VALUES (18, 'Mugglepay数字货币', 'mgcoin', 'dump', '商户号', NULL, '密钥', '/pay/mugglepay', 2, '2020-07-14 16:27:00', '2021-02-18 16:05:18');
INSERT INTO `pays` VALUES (19, 'V免签支付宝', 'vzfb', 'dump', 'v免签通讯密钥', NULL, 'V免签地址 例如 https://vpay.qq.com/    结尾必须有/', 'pay/vpay', 2, '2020-05-01 13:15:56', '2021-02-18 16:05:19');
INSERT INTO `pays` VALUES (20, 'V免签微信', 'vwx', 'dump', 'V免签通讯密钥', NULL, 'V免签地址 例如 https://vpay.qq.com/    结尾必须有/', 'pay/vpay', 2, '2020-05-01 13:17:28', '2021-02-18 16:05:20');
...
CREATE TABLE `products`  (
  ...
  `updated_at` timestamp(0) NULL DEFAULT NULL,
  `deleted_at` timestamp(0) NULL DEFAULT NULL,
  `usage_days` int(11) NOT NULL DEFAULT 1 COMMENT '卡密时长',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `webset`  (
  ...
  `img_logo` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  ...
  `langs` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `verify_code` int(1) NULL DEFAULT NULL,
  `isopen_searchpwd` int(1) NOT NULL DEFAULT 1,
  `isopen_serverj` int(1) NULL DEFAULT NULL,
  `serverj_token` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `tpl_sign` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'layui',
  `created_at` timestamp(0) NULL DEFAULT NULL,
  `updated_at` timestamp(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of webset
-- ----------------------------
INSERT INTO `webset` VALUES (1, '海马发卡 - 一站式自动售货+网络验证方案', '海马平台', 'uploads/images/default.jpg', '海马平台', '海马平台，最适合网络验证的发卡平台。', '<p>海马平台</p>', NULL, 1, 'admin@admin.com', 'zh-CN', 2, 1, 1, NULL, 'layui', '2020-04-05 22:48:12', '2021-02-19 01:27:42');
